 ...
 */
 ...
 /*
 * Modfied by moogriento
 * TP3
 * jack the ripper will know how this code was made.
 */
...
(function($, undefined) {
    ...
    ; ;
    // moog. Added to customtize the day view.
    var mTables;
    var mTableCount;
    ...
    */
    ...
    function sliceSegs(events, visEventEnds, start, end) {
        ...
        for (i = 0; i < len; i++) {
            ...
            //alert('logic ' + eventStart + ' eventEnd ' + eventEnd);
            //alert('start ' + start + ' end ' + end);
            /*
            moog. Removed. Hopefully we won't need that.
    ...
    */
    ...
    function AgendaView(element, calendar, viewName) {
        ...
        function updateCells() {
            ...
            for (i = 0; i < mTableCount; i++) {
                ...
                // gonna use this to set the table ID :P
        ...
        function renderSlotSelection(startDate, endDate) {
            ...
            if (helperOption) {
                ...
                // moog
                if (col >= 0 && col < mTableCount) { // only works when times are on same day
    ...
    function AgendaEventRenderer() {
        ...
        function compileSlotSegs(events) {
            ...
            //alert('events slots ' + events.length);
            ...
            for (i = 0; i < mTableCount; i++) {
                ...
                for (j = 0; j < col.length; j++) {
                    ...
                    for (k = 0; k < level.length; k++) {
                        seg = level[k];
                        // moog. MUST BE ORDERED BY TABLE ID (NUMBER) OR WE ARE FUCKED!
                        // seg.col = i;
                        seg.col = parseInt(seg.event.tableId) - 1; // due to 0 based index
                        //alert('table id ' + seg.event.tableId);
                        seg.level = j;
                        segs.push(seg);
                    }
                }
        ...
        function renderSlotSegs(segs, modifiedEventId) {
            //alert('renderSlotSegs ' + segs.length);
            ...
            for (i = 0; i < segCnt; i++) {
                ...
                //alert('seg.start ' + seg.start + ' seg.end ' + seg.end);
                top = timePosition(seg.start, seg.start);
                bottom = timePosition(seg.start, seg.end);
                colI = seg.col;
                levelI = seg.level;
                forward = seg.forward || 0;
                //alert('colI ' + colI + ' dis ' + dis + ' dit ' + dit);
                // colI knows where to put the crap.
