...
namespace SICR.Persistencia{
	public partial class ORDENDB{
        ...
        public StoredProcedure usp_BuscarMAsignacion(int MesCodigo){
            StoredProcedure sp=new StoredProcedure("usp_BuscarMAsignacion",this.Provider);
            sp.Command.AddParameter("MesCodigo",MesCodigo,DbType.Int32);
            return sp;
        }
        public StoredProcedure usp_EliminarPedido(int AsiCodigo){
            StoredProcedure sp=new StoredProcedure("usp_EliminarPedido",this.Provider);
            sp.Command.AddParameter("AsiCodigo",AsiCodigo,DbType.Int32);
            return sp;
        }
